package br.com.waiso.framework.log;

import java.io.ByteArrayOutputStream;
import java.io.PrintStream;

import br.com.waiso.framework.configuracao.GerenciadorConfiguracao;
import br.com.waiso.framework.email.GerenciadorEmail;
...
public class GerenciadorLog {
	...
	public static void error(Class clazz, Throwable error) {
		boolean applyError = clazz.getSimpleName().matches("(FiapServlet)");
		if(applyError){
	...
	public static boolean isDebug(Class clazz) {
		boolean isEnabled = clazz.getSimpleName().matches("(FiapServlet)");
		return isEnabled;
	}
