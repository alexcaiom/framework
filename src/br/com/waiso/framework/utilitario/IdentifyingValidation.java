...
import br.com.waiso.framework.view.ComplexValidation;
...
public class IdentifyingValidation implements ComplexValidation{
	...
	public void validate(String name, String valor) throws ErroLinkUsuario {
	...
	private void validaCPF(String campo, String cpf) {
        ...
        if (!isOk) {	
            ...
            throw new ErroLinkUsuario(campo, message);
        }
