...
import br.com.waiso.framework.view.RegexValidation;
...
public class StringUtils {
	...
	public static boolean isOnlyNumbersOrLetters(String str){
		boolean ret = false;
		if(str != null){
	...
	public static boolean isEmailValid(String str) {
		boolean ret = false;
		if(str != null){
			ret = str.matches(RegexValidation.Email.expression());
		}
		return ret;
	}
